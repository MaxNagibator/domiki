...
const inhabitants: Inhabitant[] = [
    ...
    { resident: 'артель', mech: 'workers', title: 'Трудяги', text: 'У каждого имя, характер и любимое дело. Растут в навыке до +15%, устают и отдыхают в артельной избе. Жители, а не счётчик.' },
