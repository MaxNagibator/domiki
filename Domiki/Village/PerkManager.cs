...
public class PerkManager
{
    ...
    [
        ...
        new()
        {
            ...
            Name = "Запасная койка",
            Description = "В обозе едет лишняя койка: пока артельные избы не достроены, во дворе работает на одного трудягу больше. Отстроенная деревня и без неё упирается в свои двадцать пять.",
            Costs = [6, 12],
            Level = 0,
        },
    ];
